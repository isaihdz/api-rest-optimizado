...
//*Utils
function getMoviesFilters(elements, parentElement){
  ...
  elements.forEach(movie => {
    ...
    parentElement.appendChild(movieContainer);
  });
}
function createCategories (elements, parentElement){
  parentElement.innerHTML='';
...
async function getTrendingMoviesPreview (){
  ...
  getMoviesFilters(movies,trendingMoviesPreviewList);
}
...
async function getMoviesByCategory (id){
  ...
  const movies = data.results;
  getMoviesFilters(movies,genericSection);
}
...
async function getRelatedMoviesId(id){
  ...
  getMoviesFilters(relatedMovies, relatedMoviesContainer)
}